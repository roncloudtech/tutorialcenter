  ...
  return (
    <DashboardLayout>
      <div className="xl:grid grid-cols-[1fr_0.39fr] p-2.5 xl:p-0 h-full overflow-hidden">
        {/* RIGHT SIDE */}
        <div className="xl:px-4 overflow-auto mr-1">
          ...
          <div className="questions mt-5 pt-5 pb-2 px-2.5 bg-[#EAEBEC] rounded-t-custom">
            ...
            <div className="text-xs mt-3 leading-relaxed">
              <p>
                ...
                default limit. For example, a student may choose to practice for
                5 minutes with 5 questions or attempt more questions within a
                shorter time frame, encouraging quick thinking and reading
                skills. The pass mark is set at 70, while a score of 85 and
