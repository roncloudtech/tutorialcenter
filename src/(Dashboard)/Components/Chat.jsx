    ...
    <>
      ...
      <div className="mt-5 space-y-3">
        ...
        <div className="flex items-end justify-items-start gap-2">
          ...
          <div className=" bg-white shadow-lg px-1.5 py-3  rounded-xl border-r-[4px] border-solid border-[#8695A0]">
            <div className="bg-[#EAEBEC] p-2 rounded-md">
              <h4 className="text-sm font-semibold">Peter</h4>
              <span className="text-[13px] text-[#292929CC]">
                This AI chatbot has been developed to optimize communication.
              </span>
            </div>
            <span className="text-xs  text-[#292929CC]">
              This AI chatbot has been developed to optimize communication and
              simplify work processes, ultimately leading to smoother
              operations. This AI chatbot has been developed to optimize
              communication and simplify work processes, ultimately leading to
              smoother operations. This AI chatbot has been developed to
              optimize communication and simplify work processes, ultimately
              leading to smoother operations. This AI chatbot has been developed
              to optimize communication and simplify work processes, ultimately
